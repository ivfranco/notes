...
function fheapnode_test() {
  function adjacent<K, V>(node: FHeapNode<K, V>): [K, K, K] {
    return [node.left.key, node.key, node.right.key];
  }
  let x = FHeapNode.fromKey([1, 2, 3, 4, 5]);
  let y = FHeapNode.fromKey([6, 7, 8, 9, 0]);
...
function problem_19_2_1() {
  let n39 = new FHeapNode(39, null);
  let n41 = new FHeapNode(41, null);
  let n18 = new FHeapNode(18, null);
  n18.insert(n39);
  let n52 = new FHeapNode(52, null);
  let n38 = new FHeapNode(38, null);
  n38.insert(n41);
  let n3 = new FHeapNode(3, null);
  n3.insert(n18);
  n3.insert(n52);
  n3.insert(n38);

  let n30 = new FHeapNode(30, null);
  let n17 = new FHeapNode(17, null);
  n17.insert(n30);

  let n35 = new FHeapNode(35, null);
  let n26 = new FHeapNode(26, null);
  n26.insert(n35);
  let n46 = new FHeapNode(46, null);
  let n24 = new FHeapNode(24, null);
  n24.insert(n26);
  n24.insert(n46);
  ...
  let H: FHeap<number, null> = new FHeap();
  H.min = n3;
  H.n = 12;
