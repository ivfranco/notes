...
int d_srcB = [
	...
	D_icode in { IPUSHL, ICALL, IRET, IPOPL, IPOP2 } : RESP;
	1 : RNONE;  # Don't need register
];
...
int d_dstE = [
	...
	D_icode in { IPUSHL, IPOPL, ICALL, IRET, IPOPL } : RESP;
...
bool mem_read = M_icode in { IMRMOVL, IRET, IPOP2 };
